...
//         price: "$49 - $89",
//         description:
//           "Full-service oil change with filter replacement and fluid check",
//       },
//       {
//         name: "Brake Service",
//         price: "$249 - $499",
//         description:
//           "Includes pad/shoe replacement, rotor/drum resurfacing, and brake fluid flush",
//       },
//       {
...
//         price: "$149 - $299",
//         description:
//           "Fluid exchange, filter replacement, and pan gasket replacement",
//       },
//     ],
//     certifications: [
...
//     ],
//     partsPolicy:
//       "Customer can choose parts for most repairs. We offer OEM, aftermarket, and economy options.",
//     reviews: [
//       {
//         name: "Sarah K.",
//         rating: 5,
...
//               />
//               <Text style={[styles.address, isDark && styles.textMutedLight]}>
//                 {mechanic.address}
//               </Text>
//             </View>
//           </View>
...
//           <Text style={[styles.description, isDark && styles.textMutedLight]}>
...
//                       <Text
//                         style={[styles.serviceName, isDark && styles.textLight]}
//                       >
//                         {service.name}
//                       </Text>
//                       <Text
...
//                     <Text
//                       style={[styles.reviewsTitle, isDark && styles.textLight]}
//                     >
//                       Customer Reviews
//                     </Text>
//                     <Text
...
//                         style={[
//                           styles.reviewItem,
//                           index < mechanic.reviews.length - 1 &&
//                             styles.reviewItemBorder,
...
//                           {Object.entries(mechanic.hours).map(
//                             ([day, hours], index) => (
